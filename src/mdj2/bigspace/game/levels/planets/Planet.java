...
public class Planet {
	...
	private static final PlanetInfo WATER_PLANET = new FirePlanet();
	private static final PlanetInfo EARTH_PLANET = new FirePlanet();
	private static final PlanetInfo AIR_PLANET   = new FirePlanet();
